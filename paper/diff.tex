...
%DIF ADD tci.tex        Thu Jul  9 18:56:41 2020
%% bare_jrnl.tex
%% V1.4b
%% 2015/08/26
%% by Michael Shell
...
%DIFDELCMD <  %%%
\DIFdelend We solve this cost function using the popular l1-regularized least
 squares (l1-ls) package available in~\cite{l1ls}\DIFdelbegin \DIFdel{. We also }\DIFdelend \DIFaddbegin \DIFadd{, and }\DIFaddend choose DCT as
 our sparsity basis $\boldsymbol{\Upsilon}$.  \DIFdelbegin \DIFdel{We observed that there was no significant benefit in choosing wavelets over DCT.
}%DIFDELCMD < \begin{figure}[h]
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Fig.~\ref{fig:story}
