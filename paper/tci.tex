...
\captionsetup{labelformat=empty}
    ...
    \begin{subfigure}[b]{0.176\linewidth}
        \fcolorbox{blue}{blue}{\includegraphics[width=\textwidth]{../images/okra/test_marked.png}}
\captionsetup{labelformat=empty}
        \caption{}
     \end{subfigure}
...
\textbf{Radio-frequency ablation:} We have used this dataset (Fig.~\ref{fig:RFA2_test_object-prior} to
