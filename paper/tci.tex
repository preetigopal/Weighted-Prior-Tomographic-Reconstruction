...
\hline
                   & \textbf{\begin{tabular}[c]{@{}c@{}}ground\\truth\end{tabular}} & \textbf{FDK} & \textbf{l1-ls} & \textbf{\begin{tabular}[c]{@{}c@{}}Unselective\\prior\\+ l1-ls\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Selective\\prior\\+ l1-ls\end{tabular}} \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}red RoI\\volume\end{tabular}}   & 1 (ideal)                     & \textcolor{red}{0.939}        & 0.807      & 0.712                                                               & 0.852                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}green RoI\\volume\end{tabular}} & 1 (ideal)                     & \textcolor{red}{0.918}        & 0.870      & 0.871                                                               & 0.880                                                                  \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}cyan  RoI\\volume\end{tabular}} & 1 (ideal)                     &  0.878       & \textcolor{red}{0.928}    & 0.922                                                            & 0.895                                                                  \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}full \\ volume\end{tabular}} & 1 (ideal)                     & 0.744        & 0.874       & 0.856                                                               & \textcolor{red}{0.857}                                                                  \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}red RoI in\\slice Fig.~\ref{fig:potato3D_test}\end{tabular}}   & 1 (ideal)                     & \textcolor{red}{0.945}        & 0.804       & 0.721                                                               & 0.858                                                            \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}green RoI in\\slice Fig.~\ref{fig:potato3D_test}\end{tabular}} & 1 (ideal)                     & \textcolor{red}{0.920}        & 0.872       & 0.886                                                               & 0.901                                                                  \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}cyan RoI in\\slice Fig.~\ref{fig:potato3D_test}\end{tabular}} & 1 (ideal)                     & 0.879        & \textcolor{red}{0.928}       & 0.926                                                               & 0.903                                                                  \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}full \\slice Fig.~\ref{fig:potato3D_test}\end{tabular}} & 1 (ideal)                     & 0.746        & \textcolor{red}{0.903}       & 0.866                                                               & 0.868                                                                  \\ \hline
\end{tabular}
...
\begin{table}[!h]
  \centering
\caption{Computation time for reconstruction of volumes using various methods}
\begin{tabular}{|l|c|c|c|c|c|c|c|c|}
\hline
