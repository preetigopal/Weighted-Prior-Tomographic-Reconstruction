...
%---------------------------------Unselective section---------------------
\section{Method: unselective global prior-based reconstruction}
...
In all figures in this section, `unselective prior' refers to optimizing Eq.~\ref{eq:selective_prior} with $\boldsymbol{W}(x,y,z)=1$.
%----------------------------------------------------------
%-------------------------------------------------
\subsubsection{\textbf{Okra dataset}}
\label{Sec:okra_unselective}
...
\label{fig:okra_3D_results_unselective}
\end{figure}
...
\hline
                   &  \textbf{\begin{tabular}[c]{@{}c@{}}Ground\\truth\end{tabular}} & \textbf{FDK} & \textbf{l1-ls} & \textbf{\begin{tabular}[c]{@{}c@{}}Unselective\\prior + l1-ls\end{tabular}} \\ \hline
...
\end{table}
%----------------------------------------------------------------------
\section{Method:Selective prior-based reconstruction}
...
%----------------------------------------Results-----------------------
\section{Results: Reconstruction by selective prior}
\label{sec:results}
