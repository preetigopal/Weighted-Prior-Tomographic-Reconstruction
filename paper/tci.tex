...
work of nature. In our experiments, the first 5 volumes were used to build the object-prior and the
...
\end{align}
Note that $\boldsymbol{\theta}$ is solved for using the basis pursuit CS solver, (l1-ls)~\cite{l1ls}. Solving for $\boldsymbol{\alpha}$ leads to the closed form update:
\begin{equation}
...
\caption{3D reconstruction of the okra from $10\%$ projection
  views (b) has strong streak artefacts, (c) blurred (more details in Sec. 5 of our supplementary material~\cite{supp_paper}), (d) The prior enables better reconstruction.The reconstructed volumes can be viewed in the supplementary material~\cite{supp_paper}.}
...
\begin{table}[!h]
  \centering
  \caption{SSIM of the full reconstructed okra volume by various methods. The SSIM of ground-truth (ideal reconstruction) is 1.}
\begin{tabular}{|l|c|c|c|}
\hline
                   &  \textbf{FDK} & \textbf{l1-ls} & \textbf{\begin{tabular}[c]{@{}c@{}}Uniform\\prior + l1-ls\end{tabular}} \\ \hline
\textbf{full Volume} &  0.83        &  0.87       & \textcolor{red}{0.89}                                                                                   \\ \hline
\end{tabular}
...
\begin{table}
  \centering
  \caption{SSIM of the full reconstructed sprouts volume by various methods. The SSIM of ground-truth (ideal reconstruction) is 1.}
\begin{tabular}{|l|c|c|c|c|}
\hline
                   &  \textbf{FDK} & \textbf{l1-ls} & \textbf{\begin{tabular}[c]{@{}c@{}}Uniform\\prior + l1-ls\end{tabular}} \\ \hline
\textbf{Full volume}  & 0.91        & 0.82       & \textcolor{red}{0.95}                                                                                                                       \\ \hline
\end{tabular}
...
limitation when we want accurate details of a portion, for example, of the new changes. While the
...
\textbf{\begin{tabular}[c]{@{}c@{}c@{}}Spatially\\Varying\\prior +
    l1-ls\end{tabular}} \\ \hline \textbf{red RoI} & 0.74
& 0.84 & 0.85 & \textcolor{red}{0.88} \\ \hline \textbf{green RoI} & 0.81 & 0.82 & 0.77 & \textcolor{red}{0.83}
\\ \hline
\end{tabular}
...
\begin{tabular}{|l|c|c|c|c|c|}
\hline
                   & \textbf{FDK} & \textbf{l1-ls} & \textbf{\begin{tabular}[c]{@{}c@{}}Uniform\\prior + l1-ls\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}c@{}}Spatially\\Varying\\prior + l1-ls\end{tabular}} \\ \hline
\textbf{red RoI}   & 0.85        & 0.86       & 0.83                                                               & \textcolor{red}{0.88}                                                                  \\ \hline
\end{tabular}
...
In this section, we discuss the following:  a) a realistic imaging and reconstruction protocol for longitudinal studies, b) results on homogenous dataset, and (c) tuning of the parameters used.
