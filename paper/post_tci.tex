...
\begin{table}[!h]
  \centering
  \caption{SSIM (RMSE) of reconstructed potato from various
    methods. 
...
\begin{table}[!h]
  \centering
  \caption{SSIM (RMSE) of 2D reconstruction of radio-frequency ablation data from various methods. Values have been computed within the RoI. 
...
\begin{table}[!h]
  \centering
  \caption{SSIM (RMSE) of reconstructed sprouts from various
    methods. 
%The SSIM of ideal reconstruction) is 1. The ideal RMSE is 0, and the worst RMSE possible is 1 here. 
