...
regularizer.  In particular, regions of interest (RoI) are obviously
not known in advance, and thus not considered for the purpose of
tuning.  Further, this value was retained for our spatially-varying
...
and~\ref{sec:results_without_imaging_model}.  The value of $\lambda_2$
...
regions. This value was empirically chosen to lie between $(0,3)$ for
our datasets (having the fixed $\lambda_1$).
