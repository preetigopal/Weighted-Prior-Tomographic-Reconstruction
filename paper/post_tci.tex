...
\begin{table}[!h]
  \centering
  \caption{The SSIM (RMSE) of reconstructed okra from various
    methods. SSIM of the ideal reconstruction is 1.}
\begin{tabular}{|l|c|c|c|c|c|}
\hline &
\textbf{Backprojection} & \textbf{TV} &
\textbf{This paper} \\ \hline \textbf{2D} & 0.46 (0.28)
& 0.50 (0.24) & \textcolor{red}{0.74 (0.15)} \\ \hline \textbf{3D, 30 views} & 0.69 (0.21) & 0.74 (0.30) & \textcolor{red}{0.78 (0.26)}\\
