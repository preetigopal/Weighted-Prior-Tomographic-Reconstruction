...
\begin{table}[!h]
  \centering
\caption{SSIM and RMSE of the reconstructions shown in Fig.~\ref{fig:reconstructions_diff_methods}:(a)-(h). The SSIM of ideal reconstruction is 1. The ideal RMSE is 0, and the worst RMSE possible is 1 here.}
...
the reconstructed new regions using various methods. The ground truth and reconstructions are normalized to lie in [0-1].
\begin{comment}
\begin{figure}[!h]
\centering
...
\begin{table}[!h]
  ...
  \caption{The SSIM (RMSE) of reconstructed potato from various
    methods. The SSIM of ideal reconstruction is 1. The ideal RMSE is 0, and the worst RMSE possible is 1 here. The 2D reconstructed images are shown in Fig.~\ref{fig:potato_2D_results}, and 3D reconstructed volumes can be seen in~\cite{supp_paper}.}
\begin{tabular}{|l|c|c|c|c|c|}
\hline &
\textbf{Backprojection} & \textbf{TV} &
\textbf{This paper} \\ \hline \textbf{2D, 6 views} & 0.52 (0.36)
& 0.92 (0.06) & \textcolor{red}{0.97 (0.03)} \\ \hline \textbf{3D, 18 views} & 0.58 (0.26) & 0.75 (0.21) & \textcolor{red}{0.84 (0.16)}
\\ \hline
\end{tabular}
...
Table~\ref{table:okra_ssim}. The ground truth and reconstructions are normalized to lie in [0-1].
...
\begin{table}[!h]
  ...
  \caption{The SSIM (RMSE) within the RoI of reconstructed okra from various
    methods. SSIM of the ideal reconstruction is 1. The ideal RMSE is 0, and the worst RMSE possible is 1 here.  The 2D reconstructed images are shown in Fig.~\ref{fig:okra_2D_results}, and 3D reconstructed volumes can be seen in~\cite{supp_paper}.}
\begin{tabular}{|l|c|c|c|c|c|}
\hline &
\textbf{Backprojection} & \textbf{TV} &
\textbf{This paper} \\ \hline \textbf{2D, 48 views} & 0.46 (0.28)
& 0.50 (0.24) & \textcolor{red}{0.74 (0.15)} \\ 
\hline \textbf{3D, 45 views} & 0.65 (0.22) & 0.70 (0.21) & \textcolor{red}{0.71 (0.19)}
\\ \hline
\end{tabular}
...
slice from its measurements from only 30 views. The ground truth and reconstructions are normalized to lie in [0-1] and are quantitatively compared using
...
\begin{table}[!h]
  \centering
  \caption{The SSIM (RMSE) of 2D reconstruction of radio-frequency ablation data from various methods. Values have been computed within the RoI. For ideal reconstruction, SSIM equals 1. The ideal RMSE is 0, and the worst RMSE possible is 1 here.  The  reconstructed images are shown in Fig.~\ref{fig:tmh_2D_results},}
...
reconstructed new regions as compared to other methods. The ground truth and reconstructions are normalized to lie in [0-1].
%----------------------------------------------------
...
\begin{table}[!h]
  ...
  \caption{The SSIM (RMSE) of reconstructed sprouts from various
    methods. The SSIM of ideal reconstruction) is 1. The ideal RMSE is 0, and the worst RMSE possible is 1 here. The 2D reconstructed images are shown in Fig.~\ref{fig:sprouts_2D_results}, and 3D reconstructed volumes can be seen in~\cite{supp_paper}.}
\begin{tabular}{|l|c|c|c|c|c|}
\hline &
\textbf{Backprojection} & \textbf{TV} & \textbf{This paper}
 \\ \hline \textbf{2D, 20 views} & 0.67 (0.24)
& 0.82 (0.17) & \textcolor{red}{0.86 (0.13)} \\ \hline \textbf{3D, 30 views} & 0.67 (0.25) & 0.73 (0.23) & \textcolor{red}{0.82 (0.14)}
\\ \hline
\end{tabular}
