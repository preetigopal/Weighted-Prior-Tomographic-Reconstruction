...
In this section, we first illustrate the advantage of using multiple types of eigenspaces for the computation of weights map, and then present reconstruction results on all datasets. For quantitative evaluation, we compute the Structural Similarity Index Metric (SSIM)~\cite{ssim}. Here, we assign higher importance to the preservation of structure in a reconstruction by assigning the following weights to structure, contrast and intensity respectively: $0.7,0.2,0.1$.
