...
the TV-only regularize is maintained for the method proposed in this
...
largely depends on the amount of artefacts one aims to remove by using
object-prior at the cost of their dominance in the new regions. This
value was empirically chosen to lie between $0--3$ for our datasets
