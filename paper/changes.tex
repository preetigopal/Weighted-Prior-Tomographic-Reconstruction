...
\item \textcolor{blue}{Why did the authors not choose the standard
  ...
  We have now presented RMSE values for all reconstructions in Tables 1-5 of the main paper. Since RMSE corresponds to error in intensity values, we have used SSIM with a higher weightage to structure for the purpose of measuring error in preservation of structures in our reconstructions.
  \begin{comment}
