...
For computation of both SSIM and RMSE, we find that rescaling is necessary because different optimization routines generate solutions whose intensity ranges vary from that of the ground truth. For example, for reconstruction of the potato data from 18 views, Table~\ref{Tab:ranges} shows the min. and max. intensity values of the groundtruth and reconstructed volumes.\\

\begin{table}[]
  \centering
  \caption{Minimum and maximum intensity values of groundtruth and reconstructed volumes of potato data, reconstructed from 18 views.}
  \begin{tabular}{|l|l|l|l|}
\hline
 & \textbf{\begin{tabular}[c]{@{}l@{}}Ground\\ truth\end{tabular}} & \textbf{FDK} & \textbf{TV} \\ \hline
\textbf{Min.} & 0.00 & -0.19 & 0.00 \\ \hline
\textbf{Max.} & 1.00 & 0.24 & 0.24 \\ \hline
  \end{tabular}
  \label{Tab:ranges}
\end{table}
