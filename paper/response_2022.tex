...
\subcaptionbox{Unweighted \\prior}{\includegraphics[width=0.19\columnwidth, height=0.2\textheight]{../images/thesis/okra/pca_cropped.png}}\hfill
\subcaptionbox{Weighted prior}{\includegraphics[width=0.19\columnwidth, height=0.2\textheight]{../images/thesis/okra/prior_weighted_cropped.png}}
...
\subcaptionbox{Unweighted \\prior}{\includegraphics[width=0.19\columnwidth, height=0.2\textheight]{../images/thesis/okra/zoomed/pca_cropped.png}}\hfill
\subcaptionbox{Weighted prior}{\includegraphics[width=0.19\columnwidth, height=0.2\textheight]{../images/thesis/okra/zoomed/weighted_prior_cropped.png}}
