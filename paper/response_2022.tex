...
\subcaptionbox{This paper}{\includegraphics[width=0.19\columnwidth, height=0.2\textheight]{../images/thesis/okra/prior_weighted_cropped.png}}
\caption[3D reconstruction of okra dataset]{Reconstruction from $10\%$
  views: (b) strong streak artefacts, (c) blurred, (d) no new
